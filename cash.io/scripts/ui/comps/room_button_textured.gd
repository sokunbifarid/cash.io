...
signal room_button_pressed(room_id: String, room_cost: int)
...
func set_button_data(texture_address: String = "", text: String = "", id: String = "", room_cost: int = 0) -> void:
...
func _on_pressed() -> void:
	room_button_pressed.emit(button_room_id, active_room_cost)
